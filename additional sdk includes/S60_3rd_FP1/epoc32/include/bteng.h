...
*  Version: %version:  he1cfpan#A31_47 %
*
...
// UIDs for stereo audio service
// These are copied from BT stack (from non-exported files).
const TUint KAvctpServiceUid                    = 0x100095FD;
const TUint KAvdtpUID                           = 0x100095FE;
...
NONSHARABLE_CLASS(CBTMCMSettings) : public CBase
    ...
    public:
        ...
        * Returns the BDAddress of the BT HF (mono) Accessory
        * from shared data.
        * Parameters:
        ...
        */
        ...
        /* 
        * Getter for connection status for BT HF (mono) Accessory
        ...
        */
        ...
        /*
        * Getter for shared data BDAddress
        * Returns the BDAddress of the BT A2DP (stereo) Accessory
        * from shared data.
        * Parameters:
        * @param aAddr     Function returns BDAddress via this reference
        * @return TInt     KErrNone if OK, else value indicating error situation.
        */
        IMPORT_C TInt GetStereoAccessoryAddr(TBTDevAddr& aAddr);

        /* 
        * Getter for connection status for BT A2DP (stereo) Accessory
        * Returns the connection status from shared data.
        * Parameters:
        * @param aAddr     Function returns connection status via this reference
        * @return TInt     KErrNone if OK, else value indicating error situation.
        */
        IMPORT_C TInt GetStereoConnectionStatus(TBool& aStatus);
...
class MBTMCMSettingsCB
    ...
    public:
        ...
        */
        ...
        /**
        * Pure virtual function to provide a way to notify parent instance
        * of Audio accessory address changes (HFP or Headset profile).
        * Parameters:
        * @param aAddr      Bluetooth address of the mono accessory
        * @return none
        */
        ...
        /**
        * Pure virtual function to provide a way to notify parent instance
        * of mono audio connection changes (HFP or Headset profile).
        * Parameters:
        * @param aStatus        ETrue if we have mono audio connection
        * @return none
        */
        ...
        /**
        * Pure virtual function to provide a way to notify parent instance
        * of stereo audio accessory address changes (A2DP connection).
        * Parameters:
        * @param aAddr      Bluetooth address of the A2DP connection
        * @return none
        */
        virtual void BTA2dpAccessoryChangedL (TBTDevAddr& aAddr) = 0; 

        /**
        * Pure virtual function to provide a way to notify parent instance
        * of stereo udio connection changes (A2DP connection).
        * Parameters:
        * @param aStatus        ETrue if we have an A2DP connection
        * @return none
        */
        virtual void BTA2dpConnectionStatusChangedL(TBool& aStatus) = 0; 
    };
...
class RBTDeviceHandler
    ...
    public:
        ...
        */
        ...
        /**
        * Returns an array of BT Device addresses
        * which are connected to this device.
        * If there are no connections, KErrNotFound is returned.
        * Parameters:
        * @param aAddrArray    On return, contains the BT Device addresses which are connected.
        * @return TInt         KErrNone if OK, else value indicating error situation.
        *                      KErrNotFound if there are no connections.
        */
        ...
        */
        ...
        /**
        * Returns the last used BT Devices from registry.
        * Parameters:
        * @param aDeviceArray   List of devices to be filled from BT Registry.
        * @return TInt          KErrNone if OK, else value indicating error situation.
        */
        IMPORT_C TInt GetUsedDevicesFromRegistryL(CBTDeviceArray& aDeviceArray);

        /**
        * Removes the pairing of a device from BT Registry.
        * Device to be unpaired is found according to BT Address.
        * Parameters:
        * @param aDevice        Device which will be unpaired from registry
        *                       (according to BD Address).
        * @return TInt          KErrNone if OK, else value indicating error situation.
        */
        IMPORT_C TInt UnpairDeviceL(CBTDevice& aDevice);
